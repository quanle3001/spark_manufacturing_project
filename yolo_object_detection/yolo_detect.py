...
img_ext_list = ['.jpg', '.JPG', '.jpeg',
                '.JPEG', '.png', '.PNG', '.bmp', '.BMP']
...
if record:
    ...
    record_fps = 30
    recorder = cv2.VideoWriter(record_name, cv2.VideoWriter_fourcc(
...
while True:
    ...
    for i in range(len(detections)):
        ...
        if conf > min_thresh:
            ...
            cv2.rectangle(
                frame, (xmin, label_ymin-labelSize[1]-10), (xmin+labelSize[0], label_ymin+baseLine-10), color, cv2.FILLED)
